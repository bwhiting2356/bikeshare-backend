...
var calculateArrivalTime_1 = require("../../src/findBestTrip/calculateArrivalTime");
...
describe('Calculate Arrival Time', function () {
    ...
    it('should return the query datetime', function () { return __awaiter(_this, void 0, void 0, function () {
        var query, distanceMatrixResultRow, stationEndResult, expectedTime, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = chai_1.expect;
                    return [4 /*yield*/, calculateArrivalTime_1.calculateArrivalTime(query, stationEndResult)];
                case 1:
                    _a.apply(void 0, [_b.sent()]).to.deep.equal(expectedTime);
                    return [2 /*return*/];
            }
        });
    }); });
    it('should return the calculated arrival time', function () { return __awaiter(_this, void 0, void 0, function () {
        var query, distanceMatrixResultRow, stationEndResult, expectedTime, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    expectedTime = addSeconds_1.addSeconds(new Date("2018-04-29T01:30:00.000Z"), 60);
                    _a = chai_1.expect;
                    return [4 /*yield*/, calculateArrivalTime_1.calculateArrivalTime(query, stationEndResult)];
                case 1:
                    _a.apply(void 0, [_b.sent()]).to.deep.equal(expectedTime);
...
//# sourceMappingURL=calculateArrivalTime.test.js.map