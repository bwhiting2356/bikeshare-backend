...
var getStations_1 = require("../../src/findBestStation/getStations");
...
describe('Get Stations', function () {
    ...
    it('should return all stations in the database', function () { return __awaiter(_this, void 0, void 0, function () {
        var stationsResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getStations_1.getStations()];
                case 1:
                    stationsResult = _a.sent();
                    chai_1.expect(stationsResult).to.deep.equal(mockStations_1.mockStations);
                    return [2 /*return*/];
            }
        });
    }); });
});
//# sourceMappingURL=getStations.test.js.map