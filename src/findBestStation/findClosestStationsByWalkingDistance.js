    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                distanceMatrixQuery = buildDistanceMatrixQuery_1.buildDistanceMatrixQuery('walking', stationsRawDistance, location);
                return [4 /*yield*/, fetchDistanceMatrix_1.fetchDistanceMatrix(distanceMatrixQuery)];
            case 2:
                results = _a.sent();
                return [4 /*yield*/, mergeWalkingDistanceMatrixResultWithStations_1.mergeWalkingDistanceMatrixResultWithStations(results, stationsRawDistance)];
            case 3:
...
//# sourceMappingURL=findClosestStationsByWalkingDistance.js.map